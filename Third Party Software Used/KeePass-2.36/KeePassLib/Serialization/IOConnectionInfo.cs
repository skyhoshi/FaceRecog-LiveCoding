...
namespace KeePassLib.Serialization
{
	...
	public sealed class IOConnectionInfo : IDeepCloneable<IOConnectionInfo>
	{
        ...
        public Stream Stream { get { return m_fileStream; } set { m_fileStream = value; } }
		...
		*/
	    ...
	    public static IOConnectionInfo FromStream(Stream FileStream, string strFileName)
	    {
	        IOConnectionInfo ioc = new IOConnectionInfo();

	        ioc.StreamFileName = strFileName;
	        ioc.m_fileStream = FileStream;
	    ...
	    {
	        if (m_strUrl == string.Empty && StreamFileName != string.Empty)
	        {
	            return true;
	        }
	        else
